...
export const resources = {
  ...
  en: {
    translation: {
      ...
      about: {
        title: 'Accommodation',
        intro: '<p>Nestled in the peaceful mountain village of <b>Dolní Lomná</b>, our newly built chalet offers luxurious accommodation surrounded by the beautiful nature of the Beskydy Mountains.</p><p>Located at an altitude of approximately 600 meters, the apartment provides breathtaking views of the valley and surrounding hills, creating the perfect place for relaxation in every season.</p><p>Whether you enjoy hiking, cycling, skiing, or simply unwinding in nature, you will find everything you need for a memorable stay. During winter, the nearby Severka ski resort offers excellent conditions for both downhill and cross-country skiing.</p><p>Built in 2024, the spacious apartment is fully equipped to ensure maximum comfort throughout your stay.</p>',
        welcome: {
          title: 'REFRESHMENTS UPON ARRIVAL',
          text: 'To welcome you, a chilled bottle of fine Prosecco will be waiting upon your arrival. You will also find coffee capsules, tea, and basic seasonings prepared for your first use. For wine lovers, premium wines from the South Moravian region of Čejkovice are available for an additional fee.'
        },
        sauna: {
          title: 'FINNISH SAUNA',
          text: 'The chalet also features a <b>Finnish sauna for up to 8 people</b>, located on the lower ground floor. Guests staying for a full week receive one complimentary sauna session. Sauna sheets are provided for your comfort.'
        }
      },
      gallery: {
        title: 'Gallery',
      ...
      apartments: {
        ...
        intro: 'The property offers <span class="text-gold font-bold">2 spacious and separate apartments</span>, each with its own bathroom and facilities.',
        layout: {
          text: '<ul><li><b>1 living room with kitchen and access to the terrace</b></li><li><b>2 bedrooms:</b><br>Bedroom – 1 double bed, 1 single bed<br>Bedroom – 1 double bed, 1 bunk bed for children</li></ul>'
        },
        features: {
        ...
        facilities: {
          ...
          text: '<p>The living area opens onto an east-facing terrace furnished with outdoor seating, perfect for enjoying your morning coffee or a glass of your favorite drink. The terrace offers panoramic views of this beautiful part of the Beskydy Mountains.</p><p>The apartment kitchen is fully equipped with cookware and dining sets for up to 8 people. The modern kitchen includes a large fridge with separate freezer, dishwasher, induction cooktop, oven, microwave, electric kettle, and a Nespresso capsule coffee machine.</p><p>The bedrooms are prepared with fresh bed linen, and the bathrooms provide plenty of towels and bath sheets. Basic cleaning supplies are also available, including dishwashing liquid, dishwasher tablets, kitchen sponges, and towels.</p><p>For your comfort, the bathroom is equipped with a hairdryer, shampoo, soap, and toilet paper. The garage offers secure storage and charging for your e-bikes.</p>'
        },
        pricing: {
          ...
          notesText: '<p>* Charging of electric or hybrid vehicles is not included in the price.</p><p>* STRICT NO SMOKING policy throughout all indoor areas. PETS ARE NOT ALLOWED.</p><p>* The chalet is located in the protected Beskydy landscape area. We kindly ask guests to respect nature, neighbors, and the environment, including waste sorting.</p>'
        }
      },
      booking: {
        title: 'Booking',
      ...
      reviews: {
        ...
        items: [
          {
            name: 'Lucie M.',
            text: 'Beautiful place. The apartment was brand new, clean, and luxuriously furnished. We will definitely come back!',
            rating: 5
          },
          {
            name: 'Jan P.',
            text: 'Great location for a family holiday. The owners are very kind and welcoming.',
            rating: 5
          },
          {
            name: 'Marek S.',
            text: 'Thoughtfully designed interior where you immediately feel at home. Truly beautiful accommodation and a perfect place to relax and clear your mind.',
            rating: 5
          }
        ]
      },
